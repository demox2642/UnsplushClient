...
@Entity(
    ...
    foreignKeys = [
        ForeignKey(
            ...
            parentColumns = [LocationDBContracts.Colums.ID],
            childColumns = [PhotoDBContracts.Colums.LOCATION_ID]
        ),
        ForeignKey(
            entity = PhotoDB::class,
            parentColumns = [UrlsDBContracts.Colums.ID],
            childColumns = [PhotoDBContracts.Colums.URLS_ID]
        ),
        ForeignKey(
            entity = PhotoDB::class,
            parentColumns = [UserDBContracts.Colums.ID],
            childColumns = [PhotoDBContracts.Colums.USER_ID]
        )
    ]
)
...
data class PhotoDB(
    ...
    var likes: Int? = null,
    @ColumnInfo(name = PhotoDBContracts.Colums.LOCATION_ID)
